<?php 
 $productos = [
 	[
 		'id_producto' => 1,
 		'nombre' => 'Auricular Gamer Redragon Talos H601 7.1',
 		...
 		'descr_corta' => 'Este headset de la familia Redragon asegura el mejor sonido para las mejores partidas y toda tu música.',
 	...
 	[
 		...
 		'descr_corta' => 'Los SSD WD Green mejoran la experiencia informática del día a día en su ordenador de sobremesa o portátil para un rendimiento rápido y una gran fiabilidad. ',
 	...
 	[
 		'id_producto' => 3,
 		'nombre' => 'Teclado HyperX Alloy FPS RGB Speed Kingston',
 		...
 		'descr_corta' => 'El HyperX Alloy FPS RGB™ es un teclado high-performance diseñado para garantizar 
 	tus habilidades.',
 	...
 	[
 		...
 		'descr_corta' => 'Las motherboards de la serie GIGABYTE 100 son compatibles con los procesadores Intel® Core ™ de sexta generación más recientes.',
 	...
 	[
 		'id_producto' => 5,
 		'nombre' => 'Video Radeon RX 570 4GB Gigabyte Aorus',
 		...
 		'descr_corta' => 'Las tarjetas gráficas AORUS están diseñadas para la perfección en la búsqueda de la mejor experiencia.',
 	...
 	[
 		...
 		'descr_corta' => 'El sistema RGB incorpora cuatro efectos de iluminación.',
 	...
 	[
 		'id_producto' => 7,
 		'nombre' => 'ASUS Prime H110M-P LGA1151 DDR4 HDMI VGA Micro-ATX H110 ',
 		...
 		'descr_corta' => 'Diseñado para la 7ma generación de procesadores Intel® Core ™ para maximizar la conectividad.',
 	...
 	[
 		...
 		'descr_corta' => 'Auriculares para juegos con micrófono y sonido envolvente DTS 7.1',
 	...
 	[
 		'id_producto' => 9,
 		'nombre' => 'Gabinete NZXT Noctis 450 Rog Edition SF',
 		...
 		'descr_corta' => 'El Noctis 450 original significó el regreso de NZXT a diseños audaces y atrevidos.',
 	...
 	[
 		...
 		'descr_corta' => 'EVGA 430W 80 PLUS es una gran elección a un bajo costo.',
 	...
 	[
 		...
 		'descr_corta' => 'SanDisk, pionera en tecnologías de almacenamiento de estado sólido y la marca en la que confían los profesionales. ',
